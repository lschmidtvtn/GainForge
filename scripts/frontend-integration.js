 ...
 * This file demonstrates how to integrate Gainforge with a web frontend
 */

// For React/Vue/Angular applications
export class GainforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GainforgeClient(provider, contractAddress);
